...
## Beyond reading: review actions

To post comments, reply to issues, or check CI status on a PR, use the `arcanum` skill.
It provides API-based commands: `post-comment`, `reply`, `close-issue`, `checks`, `ci-failed`.
